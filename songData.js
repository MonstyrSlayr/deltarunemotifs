...
import { Effects, EffectRef, EffectOnMotifRef, SetLyrics, AdvanceLyrics } from "./effectData.js";
...
const flowerMan = new Song("Flower Man",
    ...
    [
        ...
        new MotifReference(Motifs.PETALDANCE, quickSec(flowerManBPM, 144 + 112 + 96), quickSec(flowerManBPM, 144 + 112 + 128)),
